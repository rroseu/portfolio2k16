	...
	renderPublications() {
		return (
			<div className='section-container'>
				...
				<div className='content'>
					<p>Fox, S., Ulgado, R. R., & Rosner, D. (2015, February). <a href='http://dl.acm.org/citation.cfm?id=2675223' target='_blank'> Hacking Culture, Not Devices: Access and Recognition in Feminist Hackerspaces.</a> In Proceedings of the 18th ACM Conference on Computer Supported Cooperative Work & Social Computing (pp. 56-68). ACM.</p><br/>
					<p>Ulgado, R. R., Nguyen, K., Custodio, V. E., Waterhouse, A., Weiner, R., & Hayes, G. (2013, June). <a href='http://dl.acm.org/citation.cfm?id=2485870' target='_blank'> VidCoach: A mobile video modeling system for youth with special needs.</a> In Proceedings of the 12th International Conference on Interaction Design and Children (pp. 581-584). ACM.</p><br/>
					<p>Hayes, G.R., Custodio, V.E., Haimson, O.L., Nguyen, K., Ringland, K.E., Ulgado, R.R., Waterhouse, A., and Weiner, R. <a href='http://content.iospress.com/articles/journal-of-vocational-rehabilitation/jvr775' target='_blank'>Mobile video modeling for employment interviews for individuals with autism. </a>Journal of Vocational Rehabilitation.</p><br/>
					<p>Nguyen, K., Custodio, V.E., Ulgado, R.R., Weiner, R., Waterhouse, A., O’Neal, L., and Hayes, G.R. <a href='https://www.researchgate.net/publication/268143717_Evaluation_of_the_Use_of_Mobile_Video_Modeling_for_Job_Interviews' target='_blank'>Evaluation of the Use of Mobile Video Modeling for Job Interviews.</a> 2014 International Meeting for Autism Research.</p><br/>
					<p>Ulgado, R. R. <a href='https://github.com/allisonburtch/Critical-Theory-of-Technology/blob/master/zine.pdf' target="_blank">“On Imaginary Real Utopia.”</a> Critical Theory of Technology Zine by The School for Poetic Computation, Fall 2014.</p>
				</div>
			</div>
		);
	}
